---
title: "Tailrocks: tailrocks-retrospect — Skill definition"
description: "Verbatim definition of tailrocks-retrospect."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-retrospect/SKILL.md)
...
<retirement>^:<path>`), and record that SHA beside the bind SHA. **Bind the
   ...
   [`references/subagent-fanout.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-retrospect/references/subagent-fanout.md): read-only
...
3. **Run the detectors.** Read
   [`references/divergence-detectors.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-retrospect/references/divergence-detectors.md)
...
6. **Write the record.** Read
   [`references/patch-shape.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-retrospect/references/patch-shape.md) and copy
   [`templates/retrospective.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-retrospect/templates/retrospective.md). Fill the

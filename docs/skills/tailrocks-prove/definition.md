---
title: "Tailrocks: tailrocks-prove — Skill definition"
description: "Verbatim definition of tailrocks-prove."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/SKILL.md)
...
2. **Inventory the surfaces.** Read
   [`references/surface-inventory.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/references/surface-inventory.md).
   ...
   Read
   [`references/capability-driver.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/references/capability-driver.md), then
...
4. **Fan out, one subagent per surface.** Read
   [`references/subagent-fanout.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/references/subagent-fanout.md). Each
   agent executes its surface through `prove-driver run` and returns the typed
   receipt plus the evidence projection from
   [`references/execution-evidence.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/references/execution-evidence.md) —
...
7. **Assemble, write, and hand off.** Send only each receipt's returned
   ...
   [`templates/report.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/templates/report.md), whose shape is fixed by
   [`references/report-format.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-prove/references/report-format.md): blocking

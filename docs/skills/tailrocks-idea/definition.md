---
title: "Tailrocks: tailrocks-idea — Skill definition"
description: "Verbatim definition of tailrocks-idea."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-idea/SKILL.md)
...
Read [`references/delivery-git-contract.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-idea/references/delivery-git-contract.md)
before writing.
...
1. **Name it.** Read
   [`references/roadmap-item-format.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-idea/references/roadmap-item-format.md).

---
title: "Tailrocks: tailrocks-plan — Skill definition"
description: "Verbatim definition of tailrocks-plan."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/SKILL.md)
...
- Planning never writes reusable research. Unresolved evidence becomes the
  ...
  [`references/research-gap-manifest.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/research-gap-manifest.md),
...
- An existing `plan/` is refreshed, never duplicated — the re-run rules are in
  [`references/plan-template.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/plan-template.md).
...
1. **Ingest.** Read the roadmap item end to end, then
   [`references/coverage-ledger.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/coverage-ledger.md). Fold in
...
3. **Write the spec.** Read
   [`references/spec-format.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/spec-format.md). Write
...
4. **Slice the manifest.** Decompose the spec into ordered, never-broken
   ...
   per [`references/goal-handoff.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/goal-handoff.md).
...
5. **Write plans via subagents.** Read
   [`references/plan-template.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/plan-template.md) including
   its writer brief, and
   [`references/execution-roles.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/execution-roles.md) for which
...
7. **Write the goal handoff.** Per
   [`references/goal-handoff.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-plan/references/goal-handoff.md), write

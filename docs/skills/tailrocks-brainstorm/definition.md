---
title: "Tailrocks: tailrocks-brainstorm — Skill definition"
description: "Verbatim definition of tailrocks-brainstorm."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-brainstorm/SKILL.md)
...
2. **Seed the tree.** Read
   [`references/grilling-method.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-brainstorm/references/grilling-method.md). Build

---
title: "Tailrocks: tailrocks-reconcile — Skill definition"
description: "Verbatim definition of tailrocks-reconcile."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/SKILL.md)
...
- **Writable — the whole write surface**: the item (`roadmap/<slug>/README.md`,
  ...
  [`references/delivery-report.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/references/delivery-report.md)), the plan
...
1. **Check, then load.** An absent `roadmap/<slug>/` is a delivered item, not
   ...
   [`references/retirement.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/references/retirement.md), name the retiring
   commit, and stop — never recreate the folder. Otherwise read
   [`references/row-verification.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/references/row-verification.md): steps
...
6. **Prune, then rewrite Remaining and the report.** Per
   [`references/remaining.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/references/remaining.md): pruning is by status,
...
8. **Retire the delivered.** Four conditions, each evidenced this session:
   ...
   Per [`references/retirement.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-reconcile/references/retirement.md): never from plan

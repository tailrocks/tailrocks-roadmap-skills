---
title: "Tailrocks: tailrocks-record-feedback — Skill definition"
description: "Verbatim definition of tailrocks-record-feedback."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-record-feedback/SKILL.md)
...
4. **Write the file.** Use
   [`templates/feedback.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-record-feedback/templates/feedback.md). Statement IDs are

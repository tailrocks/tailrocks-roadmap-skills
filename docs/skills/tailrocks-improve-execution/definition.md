---
title: "Tailrocks: tailrocks-improve-execution — Skill definition"
description: "Verbatim definition of tailrocks-improve-execution."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-improve-execution/SKILL.md)
...
[`runtime-trust.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-improve-execution/references/runtime-trust.md) and
[`execution-loop.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-improve-execution/references/execution-loop.md). Source mutation is allowed

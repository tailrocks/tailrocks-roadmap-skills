---
title: "Tailrocks: tailrocks-finalize — Skill definition"
description: "Verbatim definition of tailrocks-finalize."
---

Source: [SKILL.md](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-finalize/SKILL.md)
...
1. **Load and assess.** Read `roadmap/<slug>/README.md` fully and
   [`references/readiness-and-grilling.md`](https://github.com/tailrocks/tailrocks-roadmap-skills/blob/main/skills/tailrocks-finalize/references/readiness-and-grilling.md).
